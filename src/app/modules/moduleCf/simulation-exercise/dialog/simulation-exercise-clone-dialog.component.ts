...
@Component({
  templateUrl: 'simulation-exercise-clone-dialog.component.html'
})
export class SimulationExerciseCloneDialogComponent extends CommonFormComponent implements OnInit, OnDestroy {

  // lista de versoes
  public listVersions: SoftwareVersion[];

  constructor(@Inject(MD_DIALOG_DATA) public data: any,
              private dialogRef: MdDialogRef<SimulationExerciseCloneDialogComponent>,
  ...
  public send(): void {
    ...
    if ( this.form.valid ) {
      ...
      this.simulationExerciseService.cloneData(this.form.get('sourceSoftwareVersionId').value, this.form.get('destSoftwareVersionId').value)
      .subscribe(
